...
class PromptRoberta(nn.Module):
    ...
    def forward(self, config, dataset_name, data, acc_result, mode, perturbation_mask, prompt_emb_output=False, **kwargs):
        ...
        self.activation_states = self.encoder.activation_states # write dict of activations to self.activation_states
        #self.activation_states_list = self.encoder.activation_states_list # write list of activations to self.activation_states_list
        ...
        '''
        #>>> tokenizer.encode("0") [0, 288, 2]
        #>>> tokenizer.encode("1") [0, 134, 2]
        #>>> tokenizer.encode("2") [0, 176, 2]
        #>>> tokenizer.encode("3") [0, 246, 2]
        '''
        ...
        if prompt_emb_output == True:
            ...
            return {'loss': loss, 'acc_result': acc_result, "predict": predict}
